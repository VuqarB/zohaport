...
const Adverts = () => {
  return (
    <Section padding="pt-[60px] xs:pt-[80px] md:pt-[100px] cLg:pt-[40px] pb-[80px] xs:pb-[100px] md:pb-[120px] cLg:pb-[180px]">
          ...
          <Marquee speed={150}>
            {adverts.map((item, index) => (
              <div key={index} className="flex items-center">
                <Image
                  src={item}
                  className="w-[40px] xs:w-[50px] object-cover mx-2.5 md:mx-6"
                  width={78}
                  height={51}
                  alt="adverts-img"
                />
